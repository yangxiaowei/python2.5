...
ffi_srcdir = '/media/Data/computerinfor/lanuage/Python/Python-2.5.6/Modules/_ctypes/libffi'
ffi_sources += ffi_platforms['X86']
ffi_sources = [os.path.join('/media/Data/computerinfor/lanuage/Python/Python-2.5.6/Modules/_ctypes/libffi', f) for f in ffi_sources]
