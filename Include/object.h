...
/* PyObject_HEAD 定义了每个PyObject的初始内容*/
...
/*容器*/
/*PyObject_VAR_HEAD :PyObject_HEAD;Py_ssize_t*/
                     /*对象公共内容  元素个数*/
...
typedef struct _typeobject {
	...
	destructor tp_dealloc; /*相关类型数据对象的内存的空间释放*/
	printfunc tp_print;      /*相关类型数据对象的信息打印*/ 
	getattrfunc tp_getattr; /*获取相关类型数据对象的属性*/ 
	setattrfunc tp_setattr; /*设置相关类型数据对象的属性，安装属性*/ 
	cmpfunc tp_compare; /*对相关类型进行比较的方法*/ 
	reprfunc tp_repr; /*转换成PyStringObject对象*/ 

	/* Method suites for standard classes */

	PyNumberMethods *tp_as_number; /*作为数字类型对象的操作函数族：int,long,float...*/ 
	PySequenceMethods *tp_as_sequence; /*作为序列类型对象的操作函数族：list,string*/ 
	PyMappingMethods *tp_as_mapping; /*作为映射类型对象的操作函数族：set,map*/ 
